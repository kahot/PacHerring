# Run pacadapt to find outlier loci (from Petrou et al. 2021)
...
vcf_file <- "Data/vcfs/ph_filtered_snps_minDP600_maxDP2000_minQ20_minMQ30_NS0.5_maf0.05.vcf" 
poplist_file <- "poplist_names.txt"  #optional for plotting

bed_file<-"Data/vcfs/PH.bed"
...
filename <- read.pcadapt(vcf_file, type = "bed")
filename<- read.pcadapt(bed_file, type = "bed")
##########################################################################################
