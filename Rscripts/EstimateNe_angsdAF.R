...
pws1<-read.delim("Data/new_vcf/AF/PWS91.mafs")
pws2<-read.delim("Data/new_vcf/AF/PWS96.mafs")
pws3<-read.delim("Data/new_vcf/AF/PWS07.mafs")
pws4<-read.delim("Data/new_vcf/AF/PWS17.mafs")

#combine AF for all years
pws<-cbind(pws1[,c(1,2,6)], pws2[,c(6)],pws3[,c(6)],pws4[,c(6)])
...
write.csv(pws_filtered, "Output/COV/PWS_snps_filtered_forNeestimate_angsdAF.csv")
...
write.csv(pws_Ne,"Output/COV/Ne_estimation_PWS91-17_angsdAF.csv")
...
write.csv(Ne, "Output/COV/Ne_estimation_PWS_eachTimePeriod_angsdAF.csv")
...
pws<-read.csv("Output/COV/Ne_estimation_PWS91-17_angsdAF.csv", row.names = 1)
